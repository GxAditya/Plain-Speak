...
This migration addresses the authentication problems by:
1. Ensuring proper profile creation triggers
2. Fixing RLS policies to avoid recursion
3. Adding proper error handling for profile operations

## Changes Made
1. Fixed profile creation trigger
2. Simplified RLS policies
3. Added proper admin detection
4. Fixed role/tier protection
*/
